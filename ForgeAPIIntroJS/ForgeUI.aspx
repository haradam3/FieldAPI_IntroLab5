...
<head runat="server">
    <title>Forge API Web Intro JS</title>
    <meta charset="utf-8" />
    <style type="text/css">
        #form1
        {
...
<body> 
    <form id="form1" runat="server">
        <h1>My First Forge API Web Intro JS</h1> 
    <div>
        <!-- Token -->  
    ...
    &nbsp;
        ...
        <!-- Viewer Lab 4 --> 
        <input id="ButtonView" type="button" value="View" onclick="buttonViewClicked()" />&nbsp;

        <!-- Lab 5. Properties and Search -->
        ...
        <div id="MyViewerDiv" style="position:absolute; width:97%; height:40%;"></div>
    ...
    <!-- Viewer Lab 5 --> 
    <script src="Scripts/viewerPropertiesSearch.js"></script>
    ...
    <script>
        ...
        function buttonViewClicked() {
            ...
            // Lab5
            _viewer = viewByTokenAndUrn(token, urn, "MyViewerDiv");
            ////
        }
